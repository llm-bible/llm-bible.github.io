...
additional_links:
  ...
  - {name: "Code", url: "https://github.com/wusize/F-LMM"}
tags: ['Multimodal Models', 'Model Architecture', 'Reinforcement Learning', 'Transformer', 'Fine-Tuning', 'Has Code', 'Attention Mechanism']
---
