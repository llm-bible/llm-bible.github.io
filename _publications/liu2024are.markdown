---
layout: publication
title: Are alms Effective Backbones for Fine-tuning An Experimental Investigation of Supervised alms on chines Short Text Matching
authors: Liu Shulin, Xu Chengcheng, Liu Hao, Yu Tinghao, Yang Tao
conference: "Arxiv"
year: 2024
bibkey: liu2024are
additional_links:
  - {name: "Paper", url: "https://arxiv.org/abs/2403.19930"}
tags: ['Applications', 'Attention Mechanism', 'Few Shot', 'Fine Tuning', 'Model Architecture', 'Pretraining Methods', 'Prompting', 'RAG', 'Training Techniques']
---
