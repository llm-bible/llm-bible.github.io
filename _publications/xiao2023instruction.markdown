---
layout: publication
title: Instruction45;vit Multi45;modal Prompts For Instruction Learning In Vit
...
tags: ['Model Architecture', 'Pretraining Methods', 'Prompting', 'Transformer']
---
Prompts have been proven to play a crucial role in large language models and in recent years vision models have also been using prompts to improve scalability for multiple downstream tasks. In this paper we focus on adapting prompt design based on instruction tuning into a visual transformer model for image classification which we called Instruction45;ViT. The key idea is to implement multi45;modal prompts (text or image prompt) related to category information to guide the fine45;tuning of the model. Based on the experiments of several image captionining tasks the performance and domain adaptability were improved. Our work provided an innovative strategy to fuse multi45;modal prompts with better performance and faster adaptability for visual classification models.
