---
layout: publication
title: 'Siri: A Simple Selective Retraining Mechanism For Transformer-based Visual
  Grounding'
authors: Mengxue Qu et al.
conference: Arxiv
year: 2022
citations: 15
bibkey: qu2022simple
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/2207.13325'}]
tags: [Transformer, Multimodal Models]
---
In this paper, we investigate how to achieve better visual grounding with
