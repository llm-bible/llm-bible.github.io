---
layout: publication
title: Airavata Introducing Hindi Instruction45;tuned LLM
...
---
We announce the initial release of Airavata an instruction45;tuned LLM for Hindi. Airavata was created by fine45;tuning OpenHathi with diverse instruction45;tuning Hindi datasets to make it better suited for assistive tasks. Along with the model we also share the IndicInstruct dataset which is a collection of diverse instruction45;tuning datasets to enable further research for Indic LLMs. Additionally we present evaluation benchmarks and a framework for assessing LLM performance across tasks in Hindi. Currently Airavata supports Hindi but we plan to expand this to all 22 scheduled Indic languages. You can access all artifacts at https://ai4bharat.github.io/airavata.
