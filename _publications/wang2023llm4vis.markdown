...
authors: Wang Lei, Zhang Songheng, Wang Yun, Lim Ee-peng, Wang Yong
conference: "Arxiv"
year: 2023
bibkey: wang2023llm4vis
additional_links:
  - {name: "Paper", url: "https://arxiv.org/abs/2310.07652"}
  - {name: "Code", url: "https://github.com/demoleiwang/LLM4Vis"}
  - {name: "Code", url: "https://github.com/demoleiwang/LLM4Vis"}
tags: ['ARXIV', 'Chatgpt', 'Few Shot', 'GPT', 'Has Code', 'Interpretability And Interpretability', 'LLM', 'Prompting', 'Reinforcement Learning', 'Tools', 'Training Techniques']
---
