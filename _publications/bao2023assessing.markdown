...
tags: ['Ethics And Bias', 'GPT', 'Has Code', 'Model Architecture', 'Prompting', 'Reinforcement Learning', 'Security', 'Training Techniques']
---
Large language models (LLMs) such as LLaMA Alpaca Vicuna GPT45;3.5 and GPT45;4 have advanced the performance of AI systems on various natural language processing tasks to human45;like levels. However their generalisation and robustness when performing logical reasoning has not been sufficiently assessed. To comprehensively evaluate this ability we develop three new logical reasoning datasets named ReClor45;plus LogiQA45;plus and LogiQAv245;plus that extend standard logical reasoning datasets to evaluate the robustness of the LLMs reasoning. For each we create three subsets the first with randomly shuffled options the second with the correct choices replaced by none of the other options is correct and the third with a combination of shuffling and substitution. Experiments on these datasets show that these simple augmentations greatly hinder the models performance. Despite their high performance on the original publicly available datasets we find that all models perform poorly on these newly constructed datasets. We also demonstrate that introducing task variations into the training set can markedly improve the models performance on both the original and our developed datasets. Finally we show that applying logic45;driven data augmentation for fine45;tuning and prompting can enhance generalisation in both discriminative and generative models offering a path to improving their robustness for tasks involving logical reasoning. Source code and data are made publicly available at https://github.com/Strong&#45;AI&#45;Lab/Logical&#45;and&#45;abstract&#45;reasoning.
