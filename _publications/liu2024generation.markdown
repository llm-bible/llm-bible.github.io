---
layout: publication
title: 'The Generation Gap:exploring Age Bias In The Underlying Value Systems Of Large Language Models'
authors: Liu Siyang, Maturi Trish, Yi Bowen, Shen Siqi, Mihalcea Rada
conference: "Arxiv"
year: 2024
bibkey: liu2024generation
additional_links:
  - {name: "Paper", url: "https://arxiv.org/abs/2404.08760"}
tags: ['Ethics And Bias', 'Prompting', 'RAG', 'Reinforcement Learning', 'Security', 'Survey Paper']
---
In this paper, we explore the alignment of values in Large Language Models
...
in LLMs and provide insights for future work.
