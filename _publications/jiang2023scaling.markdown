...
additional_links:
  ...
  - {name: "Code", url: "https://github.com/kongds/scaling\_sentemb"}
tags: ['Fine Tuning', 'GPT', 'Has Code', 'In Context Learning', 'Language Modeling', 'Pretraining Methods', 'Prompting', 'Training Techniques']
---
