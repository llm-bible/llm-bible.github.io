...
tags: ['Applications', 'GPT', 'Has Code', 'Model Architecture', 'Training Techniques']
---
Large language models (LLMs) have demonstrated impressive performance on various downstream tasks without requiring fine45;tuning including ChatGPT a chat45;based model built on top of LLMs such as GPT45;3.5 and GPT45;4. Despite having a lower training proportion compared to English these models also exhibit remarkable capabilities in other languages. In this study we assess the performance of GPT45;3.5 and GPT45;4 models on seven distinct Arabic NLP tasks sentiment analysis translation transliteration paraphrasing part of speech tagging summarization and diacritization. Our findings reveal that GPT45;4 outperforms GPT45;3.5 on five out of the seven tasks. Furthermore we conduct an extensive analysis of the sentiment analysis task providing insights into how LLMs achieve exceptional results on a challenging dialectal dataset. Additionally we introduce a new Python interface https://github.com/ARBML/Taqyim that facilitates the evaluation of these tasks effortlessly.
