...
bibkey: ren2024llms
additional_links:
  - {name: "Paper", url: 'https://arxiv.org/abs/2410.10700'}
  - {name: "Code", url: 'https://github.com/AI45Lab/ActorAttack'}
tags: ['Attention Mechanism', 'Has Code', 'Efficiency and Optimization', 'Security', 'Model Architecture', 'Training Techniques', 'Fine-Tuning', 'Prompting', 'Pre-Training', 'Responsible AI', 'Pretraining Methods']
---
