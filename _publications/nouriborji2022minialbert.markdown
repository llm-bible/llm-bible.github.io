...
conference: "Arxiv"
year: 2022
bibkey: nouriborji2022minialbert
additional_links:
...
tags: ['ARXIV', 'Applications', 'BERT', 'Distillation', 'Efficiency And Optimization', 'Fine Tuning', 'Has Code', 'Model Architecture', 'NLP', 'Pretraining Methods', 'Reinforcement Learning', 'Transformer']
---
