...
conference: "Arxiv"
year: 2022
bibkey: li2022lavender
additional_links:
  - {name: "Paper", url: "https://arxiv.org/abs/2206.07160"}
  - {name: "Code", url: "https://github.com/microsoft/LAVENDER"}
tags: ['Applications', 'BERT', 'Few Shot', 'Has Code', 'Language Modeling', 'Masked Language Model', 'Model Architecture', 'Multimodal Models', 'Pretraining Methods', 'Reinforcement Learning', 'Tools', 'Training Techniques']
---
