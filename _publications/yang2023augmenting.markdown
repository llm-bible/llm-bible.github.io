...
---
Large language models (LLMs) demonstrate promising translation performance among various natural languages. However many LLMs especially the open45;sourced ones such as BLOOM and LLaMA are English45;dominant and support only dozens of natural languages making the potential of LLMs on language translation less explored. In this work we present BigTranslate which adapts LLaMA that covers only 20 languages and enhances it with multilingual translation capability on more than 100 languages. BigTranslate is built upon LLaMA45;13B and it is optimized in three steps. First we continue training LLaMA with massive Chinese monolingual data. Second we continue training the model with a large45;scale parallel dataset that covers 102 natural languages. Third we instruct45;tune the foundation model with multilingual translation instructions leading to our BigTranslate model. The preliminary experiments on multilingual translation show that BigTranslate performs comparably with ChatGPT and Google Translate in many languages and even outperforms ChatGPT in 8 language pairs. We release the BigTranslate model and hope it can advance the research progress.
