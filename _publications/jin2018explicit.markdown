...
authors: Xisen Jin et al.
conference: The 27th ACM International Conference on Information and Knowledge Management
  2018
year: 2018
citations: 33
bibkey: jin2018explicit
additional_links: [{name: Paper, url: 'https://arxiv.org/abs/1808.10596'}]
tags: [Interpretability and Explainability, Model Architecture]
---
...
*expensive nature of state labeling* and the *weak interpretability*
...
states.
  In this paper, we propose the *semi-supervised explicit dialogue state
tracker* (SEDST) for neural dialogue generation. To this end, our approach has
two core ingredients: *CopyFlowNet* and *posterior regularization*.
Specifically, we propose an encoder-decoder architecture, named
*CopyFlowNet*, to represent an explicit dialogue state with a
