...
---
We introduce RecurrentGemma a family of open language models which uses Googles novel Griffin architecture. Griffin combines linear recurrences with local attention to achieve excellent performance on language. It has a fixed45;sized state which reduces memory use and enables efficient inference on long sequences. We provide two sizes of models containing 2B and 9B parameters and provide pre45;trained and instruction tuned variants for both. Our models achieve comparable performance to similarly45;sized Gemma baselines despite being trained on fewer tokens.
