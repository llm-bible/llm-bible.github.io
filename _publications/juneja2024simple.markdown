---
layout: publication
title: (texttt)lm^(texttt)2 A Simple Society Of Language Models Solves Complex Reasoning
...
additional_links:
  ...
  - {name: "Code", url: "https://github.com/LCS2-IIITD/Language\_Model\_Multiplex)"}
