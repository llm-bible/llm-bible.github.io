---
layout: publication
title: Attention Satisfies A Constraint45;satisfaction Lens On Factual Errors Of Language Models
...
---
We investigate the internal behavior of Transformer45;based Large Language Models (LLMs) when they generate factually incorrect text. We propose modeling factual queries as constraint satisfaction problems and use this framework to investigate how the LLM interacts internally with factual constraints. We find a strong positive relationship between the LLMs attention to constraint tokens and the factual accuracy of generations. We curate a suite of 10 datasets containing over 40000 prompts to study the task of predicting factual errors with the Llama45;2 family across all scales (7B 13B 70B). We propose SAT Probe a method probing attention patterns that can predict factual errors and fine45;grained constraint satisfaction and allow early error identification. The approach and findings take another step towards using the mechanistic understanding of LLMs to enhance their reliability.
