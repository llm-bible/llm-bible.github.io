...
tags: ['Efficiency and Optimization', 'Training Techniques', 'Quantization', 'Prompting', 'Applications']
---
...
address this gap, we suggest the use of *Mixture of Prompts*, or MoPs,
