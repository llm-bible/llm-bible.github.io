...
authors: Jin Yang, Xu Kun, Xu Kun, Chen Liwei, Liao Chao, Tan Jianchao, Huang Quzhe, Chen Bin, Lei Chenyi, Liu An, Song Chengru, Lei Xiaoqiang, Zhang Di, Ou Wenwu, Gai Kun, Mu Yadong
conference: "Arxiv"
year: 2023
bibkey: jin2023unified
additional_links:
  - {name: "Paper", url: "https://arxiv.org/abs/2309.04669"}
  - {name: "Code", url: "https://github.com/jy0205/LaVIT"}
tags: ['ARXIV', 'Applications', 'Has Code', 'LLM', 'Language Modeling', 'Multimodal Models', 'Pretraining Methods', 'Prompting', 'Reinforcement Learning', 'Training Techniques']
---
