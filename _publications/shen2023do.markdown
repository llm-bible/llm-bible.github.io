...
tags: ['Transformer', 'Training Techniques', 'Model Architecture', 'Prompting', 'In-Context Learning', 'Pretraining Methods']
---
...
example, their experimental verification uses *ICL objective* (training
...
*the equivalence between ICL and GD remains an open hypothesis* and calls
for further studies.
