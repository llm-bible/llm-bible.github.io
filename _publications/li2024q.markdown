...
additional_links:
  ...
  - {name: "Code", url: "https://github.com/mansicer/Q-Adapter"}
tags: ['Agentic', 'Tools', 'TACL', 'Reinforcement Learning', 'ACL', 'Has Code']
---
Large Language Models (LLMs), trained on a large amount of corpus, have
...
since most of them are trained for *general* purposes. Thus, the demands
...
pre-trained LLM and the *residual Q-function* without the reward function
